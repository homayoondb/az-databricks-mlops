"""Model deployment via Unity Catalog alias promotion.

Promotes the latest validated model version to the appropriate alias:
...
def promote_model(model_name: str, env: str) -> None:
    """Promote the latest model version based on target environment.
